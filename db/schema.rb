...
ActiveRecord::Schema.define(version: 20171022005349) do
  ...
  create_table "icos", force: :cascade do |t|
    ...
    t.datetime "ico_main_sale_open"
    t.datetime "ico_main_sale_close"
    t.index ["ico_ticker"], name: "index_icos_on_ico_ticker", unique: true
  end
